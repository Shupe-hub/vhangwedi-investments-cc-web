            ...
            <div className="footer-container">
                ...
                <div className="footer-brand">
                    ...
                    <div className="footer-socials">
                        ...
                        >
                            <svg viewBox="0 0 24 24">
                                <path d="M12 2.16c3.2 0 3.58.01 4.85.07 1.17.06 1.8.25 2.22.42.56.22.96.48 1.38.9.42.42.68.82.9 1.38.17.42.36 1.05.42 2.22.06 1.27.07 1.65.07 4.85s-.01 3.58-.07 4.85c-.06 1.17-.25 1.8-.42 2.22-.22.56-.48.96-.9 1.38-.42.42-.82.68-1.38.9-.42.17-1.05.36-2.22.42-1.27.06-1.65.07-4.85.07s-3.58-.01-4.85-.07c-1.17-.06-1.8-.25-2.22-.42a3.77 3.77 0 0 1-1.38-.9 3.77 3.77 0 0 1-.9-1.38c-.17-.42-.36-1.05-.42-2.22C2.17 15.58 2.16 15.2 2.16 12s.01-3.58.07-4.85c.06-1.17.25-1.8.42-2.22.22-.56.48-.96.9-1.38.42-.42.82-.68 1.38-.9.42-.17 1.05-.36 2.22-.42C8.42 2.17 8.8 2.16 12 2.16zm0-2.16C8.74 0 8.33.01 7.05.07 5.78.13 4.9.35 4.14.65a6.1 6.1 0 0 0-2.22 1.43A6.1 6.1 0 0 0 .49 4.14c-.3.76-.52 1.64-.58 2.91C-.01 8.33 0 8.74 0 12c0 3.26-.01 3.67.07 4.95.06 1.27.28 2.15.58 2.91.31.77.72 1.43 1.43 2.14a6.1 6.1 0 0 0 2.22 1.43c.76.3 1.64.52 2.91.58 1.28.06 1.69.07 4.95.07s3.67-.01 4.95-.07c1.27-.06 2.15-.28 2.91-.58a6.1 6.1 0 0 0 2.22-1.43 6.1 6.1 0 0 0 1.43-2.22c.3-.76.52-1.64.58-2.91.06-1.28.07-1.69.07-4.95s-.01-3.67-.07-4.95c-.06-1.27-.28-2.15-.58-2.91a6.1 6.1 0 0 0-1.43-2.22A6.1 6.1 0 0 0 19.86.65c-.76-.3-1.64-.52-2.91-.58C15.67.01 15.26 0 12 0z" />
